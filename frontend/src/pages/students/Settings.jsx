...
import { Settings as SettingsIcon, Bell, Lock, ShieldCheck, Save } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#f8faff] p-4 md:p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm md:p-8">
          ...
          <h1 className="mt-3 text-3xl font-bold text-slate-900">Account Settings</h1>
        ...
        <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-4 space-y-3">
            <ToggleRow
              ...
              description="Receive evaluation reminders and mentor feedback by email."
              value={emailNotifications}
              onChange={() => setEmailNotifications((prev) => !prev)}
            />
            <ToggleRow
              label="Push Notifications"
              description="Receive instant notifications in the app."
        ...
        <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-4 space-y-3">
            <ToggleRow
              ...
              description="Allow mentors and admins to view your profile details."
              value={showProfilePublic}
              onChange={() => setShowProfilePublic((prev) => !prev)}
            />
            <ToggleRow
