      ...
      <div className="md:hidden bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between sticky top-0 z-40">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/admin/dashboard')}>
          ...
          <div className="min-w-0">
            ...
            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Administrator</p>
          </div>
        </div>
          ...
          <div className="fixed inset-0 z-[200] md:hidden">
            ...
            >
              ...
              <div className="p-5 border-b border-slate-100 flex items-center justify-between">
                <BrandLogo title="PNC Student Star" subtitle="Administrator" />
                <button
                  onClick={() => setIsDrawerOpen(false)}
              ...
              <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                <p className="px-3 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Admin Panel</p>
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.hasNotification && (
                        <span className="absolute right-4 top-1/2 -translate-y-1/2 size-2 bg-red-500 rounded-full ring-2 ring-white" />
                      )}
                    </button>
                  );
                })}
          ...
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className={cn(
                  "text-[9px] font-bold truncate max-w-[56px]",
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-6 h-0.5 bg-primary rounded-full"
                    transition={{ type: 'spring', damping: 30, stiffness: 400 }}
                  />
                )}
                {item.hasNotification && (
                  <span className="absolute top-0.5 right-1 size-2 bg-red-500 rounded-full ring-2 ring-white" />
                )}
              </button>
            );
          })}
