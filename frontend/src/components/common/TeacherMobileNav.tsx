...
const menuItems = [
  ...
  { icon: Bell, label: 'Alerts', path: '/teacher/notifications' },
...
const drawerMenuItems = [
  ...
  { icon: BarChart3, label: 'Visual Reports', path: '/teacher/reports' },
      ...
      <div className="md:hidden bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between sticky top-0 z-40">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/teacher/dashboard')}>
          ...
          <div className="min-w-0">
            ...
            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Teacher Portal</p>
          </div>
        </div>
          ...
          <div className="fixed inset-0 z-[200] md:hidden">
            ...
            >
              ...
              <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                <p className="px-3 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Teacher Menu</p>
