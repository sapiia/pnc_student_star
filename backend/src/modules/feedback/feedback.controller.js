...
const { emitFeedbackEvent, emitNotificationEvent } = require('../../app/realtime');
...
const createFeedback = async (req, res) => {
  try {
    ...
    const teacherProfile =
      String(createdFeedback?.teacher_profile_image || '').trim() ||
      `${baseUrl}/uploads/logo/star_gmail_logo.jpg`;
